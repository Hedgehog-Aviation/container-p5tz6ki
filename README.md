...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-p5tz6ki.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-p5tz6ki.containers.anotherwebservice.com/
...
```
git clone git@github.com:Hedgehog-Aviation/container-p5tz6ki.git
cd container-p5tz6ki
```
...
```
docker attach container-p5tz6ki
```
